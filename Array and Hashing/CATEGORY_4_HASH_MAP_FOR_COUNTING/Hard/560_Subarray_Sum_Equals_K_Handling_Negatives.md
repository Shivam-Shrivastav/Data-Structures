...
# 560 Subarray Sum Equals K Handling Negatives

## 1. Problem Statement with Example
Given the problem **560 Subarray Sum Equals K Handling Negatives**, solve it efficiently using the most suitable Array/Hashing pattern.
