...
# 128 Longest Consecutive Sequence On

## 1. Problem Statement with Example
Given the problem **128 Longest Consecutive Sequence On**, solve it efficiently using the most suitable Array/Hashing pattern.
