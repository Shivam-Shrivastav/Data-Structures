...
# Maximum Product Subarray Negative Handling

## 1. Problem Statement with Example

Solve **Maximum Product Subarray Negative Handling** using the most optimal Array / Hashing / Prefix Sum / Matrix pattern.
