...
# 49 Group Anagrams Optimization with Prime Numbers

## 1. Problem Statement with Example

Solve **49 Group Anagrams Optimization with Prime Numbers** using the most optimal Array / Hashing / Prefix Sum / Matrix pattern.
